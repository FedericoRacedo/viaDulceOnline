...
async function cargarProductos() {
    try {
        const response = await fetch('../json/galletitas.json'); // Verifica esta ruta
        if (!response.ok) {
...
function agregarFiltros(productos) {
    ...
    document.getElementById('filtro-salada').addEventListener('click', () => {
        filtrarPorCategoria(productos, 'Salada');
    });

    document.getElementById('filtro-sinSal').addEventListener('click', () => {
        filtrarPorCategoria(productos, 'Sin sal');
    });

    document.getElementById('filtro-trio').addEventListener('click', () => {
        filtrarPorCategoria(productos, 'Trio')
    });


    document.getElementById('filtro-parNor').addEventListener('click', () => {
        filtrarPorCategoria(productos, 'ParNor/Fachitas')
    });
